...
f value should be very close to 0
energy function should only take in the input x and it should calculate the gradient inside of it
if i plug values into the energy function I should get 0 or very close to it like x^-5
do this because even tho I am getting the results the paper got we dont know if they have the best results we may have better
need to factor in dual players
derivative of dual players with respect to d is h'(x) = -g(x)
